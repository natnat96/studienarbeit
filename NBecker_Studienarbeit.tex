...
% Potenziale vielleicht keine konkreten anwendunge, diese nur als beispiel sondern mehr aus die Technologien und die Anwendabrkeit der Technologien gehen: Computer vision, NLP, Gernerierung von sprache, ... betrachten und dann je 1-2 beispiele eingeornet nicht den produktionsteil, wo das zum Einsatz kommen könnte. 

% das das potential nciht allein bei KI liegt sondern die verbindung von KI mit anderen Tachnologie der Dgigitalisierung, wie zb Datennetze 5G ud so

% und viellecith auf die Chancen und Hemmniss aus dem vorherigen section eingehen, wie die gelöst werden können zb dass die sachen einfacher implemenitert und verstanden werden können

%Daten von Hersteller und Nutze on Maschinen . Z.B könnte ein Hersteller von Produktionsmaschinen mit Sensordaten, die während der Nutzung der Maschinen anfallen, Verbesserung an den Maschinen vornehmen oder den Produktionsarbeitern detailliertere Informationen über den Zustand von Maschinen und ausgerüsteten Werkzeugen geben.
