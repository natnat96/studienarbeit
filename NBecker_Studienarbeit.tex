...
% Computer vision, NLP, Gernerierung von sprache, ... betrachten und dann je 1-2 beispiele eingeornet in den produktionsteil, wo das zum Einsatz kommen könnte. 
...
%Nachhaltigkeit? Mit seinen Lösungen aus dem Digital-Enterprise-Portfolio und den digitalen Zwillingen von Produkt, Produktion und Performance sparen Kunden Ressourcen wie Energie, Wasser und Abwasser und reduzieren Abfall sowie CO2-Emissionen 36

%Deutschland besitzt im internationalen Wettbewerb eine hervorragende Ausgangsposition, um die digitale Transformation der Industrie mitzugestalten. Damit der Standort Deutschland seinen Vorsprung halten kann, müssen Politik, Wirtschaft, Wissenschaft und Gesellschaft aber noch große Aufgaben bewältigen. Dies beginnt bei den technologischen Voraussetzungen für eine flächendeckende und schnelle Datenübertragung, geht über neue Bildungskonzepte und reicht bis zu einem Mentalitätswandel von Wirtschaft und Gesellschaft. \cite{36}
...
%Potenziale sind also neben der Entwicklung von neuen KI-Anwendungen die Nutzbarmachung von existierenden und verfügbaren Technologien und dementsprechend das Abbauen der im vorhergehen Kapitel beschriebenen Hemmnisse. <- guter Satz für Fazit
%das das potential nicht allein bei KI liegt sondern die Verbindung von KI mit anderen Technologie der Digitalisierung, wie zb Datennetze 5G ud so
